...
public class Throw {
	...
	public static Gag useThrowGag(UUID playerUUID, Main main, String gag, int track, int numInTrack) {
	...
	public static int getMinDmg(String gag) {
		Class<?> gagc;
		try {
			gagc = Class.forName("me.WesBag.Toontown.BattleCore.Gags.Throw." + gag + ".Gag");
